...
<div class="container-fluid admin_menu">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
        <?php if(is_array($fitData)): foreach($fitData as $key=>$v): ?><tr>
                <td><?php echo ($v["fitid"]); ?></td>
                <td>
                    <?php echo ($v["fit_con"]); ?>
                </td>
                <td>
                    <?php echo ($v["unfit_con"]); ?>
                </td>
                <td>
                    <?php switch($v["fit_tipid"]): case "1": ?><code>吃</code><?php break;?>
                        <?php case "2": ?><code>睡</code><?php break;?>
                        <?php case "3": ?><code>动</code><?php break;?>
                        <?php case "4": ?><code>护</code><?php break; endswitch;?>
                </td>
            <td>
                <div class="btn-group">
