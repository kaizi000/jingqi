...
<head>
    ...
    <link href="__PUBLIC__/admin/jqjs/css/bootstrap.min.css" rel="stylesheet">
    <link href="__PUBLIC__/css/site.css" rel="stylesheet">
    <link href="__PUBLIC__/admin/jqjs/css/font-awesome.min.css" rel="stylesheet">
    <script src="__PUBLIC__/admin/jqjs/js/jquery.min.js"></script>
    <script src="__PUBLIC__/admin/jqjs/app/util.js"></script>
    <script src="__PUBLIC__/admin/jqjs/require.js"></script>
    <script src="__PUBLIC__/admin/jqjs/app/config.js"></script>
    <!--[if lt IE 9]>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus" >
                ...
                <ul class="list-group menus collapse in" id="collapseExample">
                    <a href="{:U('Fit/index')}" class="list-group-item" >
                        <i class="fa fa-align-center" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        宜忌列表
                    </a>
                    <a href="{:U('Fit/addFit')}" class="list-group-item" >
                ...
                <ul class="list-group menus collapse in" id="collapseExample2">
                    <a href="{:U('Moodimg/index')}" class="list-group-item" >
                        <i class="fa fa-hand-spock-o" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        心情列表
                    </a>
                    <a href="{:U('Moodimg/addMood')}" class="list-group-item" >
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="{:U('CmsCate/index')}" class="list-group-item" >
                        <i class="fa fa-hand-spock-o" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        分类列表
                    </a>
                    <a href="{:U('CmsCate/addCate')}" class="list-group-item" >
                        <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        添加分类
                    </a>
...
<!--                cms及频道分类 end-->
                ...
                <ul class="list-group menus collapse in" id="collapseExample4">
                    <a href="{:U('Node/index')}" class="list-group-item" >
                        <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        节点列表
                    </a>
                    <a href="{:U('Node/addNode')}" class="list-group-item" >
                        <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        节点新增
                    </a>
                ...
                <div class="panel-heading" role="button" data-toggle="collapse" href="#collapseExample5" aria-expanded="false" aria-controls="collapseExample">
                    <h4 class="panel-title">CMS文章管理</h4>
                ...
                <ul class="list-group menus collapse in" id="collapseExample5">
                    <a href="{:U('Cms/index')}" class="list-group-item" >
                        <i class="fa fa-hand-spock-o" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章列表
                    </a>
                    <a href="{:U('Cms/addArt')}" class="list-group-item" >
                        <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章添加
                    </a>
