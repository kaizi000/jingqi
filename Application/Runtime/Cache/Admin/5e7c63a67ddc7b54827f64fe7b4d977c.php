...
<head>
    ...
    <link href="/jingqi2.0/Public/admin/jqjs/css/bootstrap.min.css" rel="stylesheet">
    <link href="/jingqi2.0/Public/css/site.css" rel="stylesheet">
    <link href="/jingqi2.0/Public/admin/jqjs/css/font-awesome.min.css" rel="stylesheet">
    <script src="/jingqi2.0/Public/admin/jqjs/js/jquery.min.js"></script>
    <script src="/jingqi2.0/Public/admin/jqjs/app/util.js"></script>
    <script src="/jingqi2.0/Public/admin/jqjs/require.js"></script>
    <script src="/jingqi2.0/Public/admin/jqjs/app/config.js"></script>
    <!--[if lt IE 9]>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus" >
                ...
                <ul class="list-group menus collapse in" id="collapseExample2">
                    <a href="<?php echo U('Cms/index');?>" class="list-group-item" >
                        <i class="fa fa-hand-spock-o" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章列表
                    </a>
                    <a href="<?php echo U('Cms/addArt');?>" class="list-group-item" >
                        <i class="fa fa-hand-o-right" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章添加
                    </a>
